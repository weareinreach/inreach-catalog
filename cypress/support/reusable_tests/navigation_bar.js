Cypress.Commands.add('testNavigationBar',(viewport)=>{
    //set viewport
    cy.viewport(viewport);
    // eslint-disable-next-line default-case
    switch(viewport){
        case Cypress.env('desktop'):
            testNavigationBarDesktop();
            break;
        case Cypress.env('tablet'):
            testNavigationBarTablet();
            break;
...
//desktop
function testNavigationBarDesktop(){
...
function testNavigationBarTablet(){
