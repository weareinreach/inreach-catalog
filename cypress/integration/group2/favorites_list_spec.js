    ...
    viewports.forEach(viewport => {
        context(`Testing the ${viewport} Version of the application`, () => {
            ...
            it(`Favorites List Delete List - Response not 200`, () => {
                cy.get('@user').then(user => {
                    cy.testDeletingFavoritesListErrorErrorCode(viewport, user, "Automation List 4", 999, "Oops! Something went wrong.");
                });
            });
            it(`Favorites List Delete List - Generic Error`, () => {
                cy.get('@user').then(user => {
                    cy.testDeletingFavoritesListErrorSomethingElse(viewport, user, "Automation List 4");
                });
            });
        });
    });
