...
const resourceTypes = [
  ...
  },
  {
    category: 'Medical',
    type: 'medical',
    odTag: 'Medical emergency',
    title: 'Medical clinics'
  },
  {
    category: 'Medical',
    type: 'transportation',
    odTag: 'Transportation for healthcare',
    title: 'Medical clinics'
  },
  {
    category: 'Medical',
  ...
  },
  {
    category: 'Medical',
    type: 'medical',
    odTag: 'Physical evaluations for asylum claim',
    title: 'Physical evaluations for asylum claim'
  },
  {
    category: 'Medical',
    type: 'medical',
    odTag: 'Transgender health',
    title: 'Trans health'
  },
  {
    category: 'Medical',
  ...
  },
  {
    category: 'Medical',
    type: 'medical',
    odTag: 'Sex worker health services',
    title: 'HIV and sexual health',
    iconOnly: true
  },
  {
  ...
  },
  {
    category: 'Medical',
    type: 'medical',
    odTag: 'Gender affirming surgery',
    title: 'Trans health',
    iconOnly: true
  },
  {
  ...
  },
  {
    category: 'Legal',
    type: 'legal',
    odTag: 'DACA application/renewal',
  ...
  },
  {
    category: 'Legal',
    type: 'legal',
    odTag: 'Name & gender change',
    title: 'Name and gender change'
  },
  {
    category: 'Legal',
    type: 'legal',
    odTag: 'Special Immigrant Juvenile Status (SIJS)',
  ...
  {category: 'Legal', type: 'legal', odTag: 'Dependency court', iconOnly: true},
  {
    category: 'Legal',
    type: 'legal',
    odTag: 'Wills & health care directives',
    iconOnly: true
  },
  ...
  {category: 'Legal', type: 'legal', odTag: 'Immigration law', iconOnly: true},
  {
    category: 'Legal',
    type: 'legal',
    odTag: 'Visas & other statuses',
    iconOnly: true
  },
  {
    category: 'Legal',
    type: 'legal',
    odTag: 'Citizenship & naturalization',
    iconOnly: true
  },
  {
    category: 'Legal',
    type: 'legal',
    odTag: 'Criminal Law & re-entry',
    iconOnly: true
  },
  {
    category: 'Legal',
    type: 'legal',
    odTag: 'Warrants & active cases',
    iconOnly: true
  },
  {
    category: 'Legal',
    type: 'legal',
    odTag: 'Re-entry legal support',
    iconOnly: true
  },
  {
    category: 'Legal',
    type: 'legal',
    odTag: 'Loss of ID & tickets',
    iconOnly: true
  },
  {
    category: 'Legal',
    type: 'legal',
    odTag: 'Criminal record help',
    iconOnly: true
  },
  ...
  {category: 'Housing', type: 'housing', odTag: 'Homeowner resources'},
  {
    category: 'Housing',
    type: 'housing',
    odTag: 'Drop-in centers',
    title: 'Drop-in centers for LGBTQ youth'
  },
  {
    category: 'Housing',
    type: 'housing',
    odTag: 'Overnight shelters',
    title: 'Emergency housing'
  },
  {
    category: 'Housing',
    type: 'housing',
    odTag: 'Shelter hotlines',
    title: 'Emergency housing'
  },
  {
    category: 'Housing',
    type: 'housing',
    odTag: 'Housing search',
    title: 'Housing information and referrals'
  },
  {
    category: 'Housing',
    type: 'housing',
    odTag: 'Temporary housing',
    title: 'Short-term housing'
  },
  {
    category: 'Housing',
    type: 'housing',
    odTag: 'Short-term shelters',
    title: 'Short-term housing',
    iconOnly: true
  },
  {
  ...
  },
  {
    category: 'Housing',
    type: 'housing',
    odTag: 'Transitional housing for victims',
    title: 'Short-term housing',
    iconOnly: true
  },
  {
    category: 'Housing',
    type: 'housing',
    odTag: 'Homeless support',
    iconOnly: true
  },
  {
    category: 'Housing',
    type: 'housing',
    odTag: 'Permanent supportive housing',
    iconOnly: true
  },
  {
    category: 'Housing',
    type: 'housing',
    odTag: 'Halfway houses',
    iconOnly: true
  },
  {
    category: 'Housing',
    type: 'housing',
    odTag: 'Independent living skills',
    iconOnly: true
  },
  ...
  {category: 'Housing', type: 'housing', odTag: 'Foreclosure', iconOnly: true},
  {
    category: 'Housing',
    type: 'housing',
    odTag: 'Deposit & rent assistance',
    iconOnly: true
  },
  {
    category: 'Housing',
    type: 'housing',
    odTag: 'Renters insurance',
    iconOnly: true
  },
  {
    category: 'Housing',
    type: 'housing',
    odTag: 'Moving assistance',
    iconOnly: true
  },
  {
    category: 'Housing',
    type: 'housing',
    odTag: 'Affordable home ownership',
    iconOnly: true
  },
  {
    category: 'Housing',
    type: 'housing',
    odTag: 'Homeowners insurance',
    iconOnly: true
  },
  {
    category: 'Housing',
    type: 'housing',
    odTag: 'Payment assistance',
    iconOnly: true
  },
  {
    category: 'Housing',
    type: 'housing',
    odTag: 'First-time homebuyers',
    iconOnly: true
  },
  ...
  /* AC Hygiene and Clothing Category */
  {
    ...
    type: 'hygiene',
    odTag: 'Heating & cooling'
  },
  {
    category: 'Hygiene and Clothing',
    type: 'hygiene',
    odTag: 'Household supplies'
  },
  {
    category: 'Hygiene and Clothing',
    type: 'hygiene',
    odTag: 'Gender-Neutral Restrooms',
  ...
  },
  {
    category: 'Hygiene and Clothing',
    type: 'hygiene',
    odTag: 'Cash for clothing',
    iconOnly: true
  },
  {
    category: 'Hygiene and Clothing',
    type: 'hygiene',
    odTag: 'General clothes',
    iconOnly: true
  },
  {
    category: 'Hygiene and Clothing',
    type: 'hygiene',
    odTag: 'School clothes',
    iconOnly: true
  },
  {
    category: 'Hygiene and Clothing',
  ...
  },
  {
    category: 'Education and Employment',
    type: 'educationEmployment',
    odTag: 'Life skills training',
    title: 'Career counseling'
  },
  {
    category: 'Education and Employment',
    type: 'educationEmployment',
    odTag: 'Financial literacy',
    title: 'Career counseling'
  },
  {
    category: 'Education and Employment',
  ...
  },
  {
    category: 'Education and Employment',
    type: 'educationEmployment',
    odTag: 'Applying for student loans',
    title: 'Scholarships'
  },
  {
    category: 'Education and Employment',
  ...
  },
  {
    category: 'Education and Employment',
    type: 'educationEmployment',
    odTag: 'Unemployment benefits',
    iconOnly: true
  },
  {
    category: 'Education and Employment',
    type: 'educationEmployment',
    odTag: 'Interview training',
    title: 'Career counseling',
    iconOnly: true
  },
  {
  ...
  },
  {
    category: 'Mental Health',
    type: 'mentalHealth',
    odTag: 'Counseling & therapy',
    title: 'Private therapy and counseling'
  },
  {
    category: 'Mental Health',
    type: 'mentalHealth',
    odTag: 'Anger management',
    title: 'Private therapy and counseling'
  },
  {
    category: 'Mental Health',
  ...
  },
  {
    category: 'Mental Health',
    type: 'mentalHealth',
    odTag: 'Psychological evaluations for asylum claim',
  ...
  },
  {
    category: 'Mental Health',
    type: 'mentalHealth',
    odTag: 'Transgender support groups',
    title: 'Trans support groups'
  },
  {
    category: 'Mental Health',
    type: 'mentalHealth',
    odTag: 'Crisis hotlines',
    title: 'Hotlines',
    iconOnly: true
  },
  {
    category: 'Mental Health',
    type: 'mentalHealth',
    odTag: 'Domestic violence hotline',
    title: 'Hotlines',
    iconOnly: true
  },
  {
  ...
  },
  {
    category: 'Mental Health',
    type: 'mentalHealth',
    odTag: 'Domestic violence text lines',
    title: 'Hotlines',
    iconOnly: true
  },
  {
  ...
  /* AC Translation and interpretation Category */
  {
    ...
    type: 'speechBubble',
    odTag: 'Translation/interpretation for healthcare'
  },
  {
    category: 'Translation and Interpretation',
    type: 'speechBubble',
    odTag: 'Translation & Interpretation'
  },
  {
    category: 'Translation and Interpretation',
    type: 'speechBubble',
    odTag: 'Translation/interpretation for legal services',
    iconOnly: true
  },
  ...
  {category: 'Transportation', type: 'transportation', odTag: 'Transportation'},
  {
    ...
    type: 'transportation',
    odTag: 'Transit passes & discounts',
  ...
  },
  {
    category: 'Transportation',
    type: 'transportation',
    odTag: 'Transportation assistance',
