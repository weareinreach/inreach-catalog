const resourceTypes = [
  ...
  {category: 'Medical', type: 'medical', odTag: 'Gynecology',                           title: 'Women\'s health',           iconOnly: true},
  ...
  {category: 'Medical', type: 'medical', odTag: 'STD tests',                            title: 'HIV and sexual health',     iconOnly: true},
  ...
  {category: 'Housing', type: 'housing', odTag: 'Permanent supportive housing',     title: 'Housing information and referrals',     iconOnly: true},
  {category: 'Housing', type: 'housing', odTag: 'Transitional housing',             title: 'Temporary housing',                     iconOnly: true},
  {category: 'Housing', type: 'housing', odTag: 'Temporary shelters',               title: 'Temporary housing',                     iconOnly: true},
  {category: 'Housing', type: 'housing', odTag: 'Halfway houses',                   title: 'Temporary housing',                     iconOnly: true},
  {category: 'Housing', type: 'housing', odTag: 'Transitional housing for victims', title: 'Temporary housing',                     iconOnly: true},
  {category: 'Housing', type: 'housing', odTag: 'Housing search',                   title: 'Housing information and referrals',     iconOnly: true},
  {category: 'Housing', type: 'housing', odTag: 'Public housing',                   title: 'Housing information and referrals',     iconOnly: true},
  {category: 'Housing', type: 'housing', odTag: 'Section 8',                        title: 'Housing information and referrals',     iconOnly: true},
  {category: 'Housing', type: 'housing', odTag: 'Housing vouchers',                 title: 'Housing information and referrals',     iconOnly: true},
  {category: 'Housing', type: 'housing', odTag: 'Affordable home ownership',        title: 'Housing information and referrals',     iconOnly: true},
  {category: 'Housing', type: 'housing', odTag: 'Deposit & rent assistance',        title: 'Housing information and referrals',     iconOnly: true},
  {category: 'Housing', type: 'housing', odTag: 'Renters insurance',                title: 'Housing information and referrals',     iconOnly: true},
  {category: 'Housing', type: 'housing', odTag: 'Tenants rights',                   title: 'Housing information and referrals',     iconOnly: true},
  {category: 'Housing', type: 'housing', odTag: 'Homeowners insurance',             title: 'Housing information and referrals',     iconOnly: true},
  {category: 'Housing', type: 'housing', odTag: 'Foreclosure',                      title: 'Housing information and referrals',     iconOnly: true},
  {category: 'Housing', type: 'housing', odTag: 'Payment assistance',               title: 'Housing information and referrals',     iconOnly: true},
  {category: 'Housing', type: 'housing', odTag: 'First-time homebuyers',            title: 'Housing information and referrals',     iconOnly: true},
  ...
  {category: 'Education and Employment', type: 'educationEmployment', odTag: 'Unemployment benefits',      title: 'Career counseling',      iconOnly: true},
  ...
  {category: 'Mental Health', type: 'mentalHealth', odTag: 'Alcohol',                   title: 'Substance use',           iconOnly: true},
  ...
  {category: 'Mental Health', type: 'mentalHealth', odTag: 'Mental health emergency',   title: 'Hotlines',                iconOnly: true},
