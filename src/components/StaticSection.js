...
class Section extends React.Component {
	...
	render() {
		var {classes, color, icon, type, title, description, resources, dropdown} =
			this.props;
		const dropdownKeys =
		...
		return (
			<div>
				...
				<Typography
					variant="h6"
					data-test-id="static-page-body-2"
				...
				<Typography
					variant="h2"
					data-test-id="static-page-body-3"
					className={[classes.applyColor, classes.titleMargin].join(' ')}
				>
					{title}
				</Typography>
				<Typography variant="body2" data-test-id="static-page-body-4">
					<ContentMarkdown
						renderers={{
							link: (props) => (
