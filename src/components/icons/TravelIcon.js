...
width={width} viewBox='0 0 38 39'>
    ...
    <g fill='none' fillRule='evenodd'>
        <g transform='translate(1.059 .732)'>
            ...
            <path fill={fillColor} d='M35.362 17.969c0 9.882-7.915 17.893-17.681 17.893C7.916 35.862 0 27.852 0 17.969 0 8.087 7.916.076 17.68.076c9.766 0 17.681 8.01 17.681 17.893'
            mask='url(#b)' />
        </g>
        <g stroke={strokeColor} strokeLinecap='round' strokeLinejoin='round' strokeWidth='0.5'>
...
TravelIcon.defaultProps = { width: '100%', fillColor: '#5073B3', strokeColor: '#FFF' }
TravelIcon.propTypes = { width: PropTypes.string, fillColor: PropTypes.string, strokeColor: PropTypes.string }
