...
const FacebookIcon = ({style, width, color}) => (
	<svg
		style={style}
		width={width}
		viewBox="0 0 16 16"
...
FacebookIcon.defaultProps = {width: '100%', color: '#5073B3'};
FacebookIcon.propTypes = {width: PropTypes.string, color: PropTypes.string};
