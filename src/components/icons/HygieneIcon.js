...
const HygieneIconIcon = ({width, fillColor}) => (
...
HygieneIconIcon.defaultProps = { width: '100%', fillColor: '#99d5d5' }
HygieneIconIcon.propTypes = { width: PropTypes.string, fillColor: PropTypes.string }
