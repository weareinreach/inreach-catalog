...
width={width} viewBox='0 0 36 38'>
    ...
    <g fill='none' fillRule='evenodd'>
        <g transform='translate(.69 1.503)'>
            ...
            <path fill={fillColor} d='M34.925 17.537C34.925 27.182 27.108 35 17.463 35S0 27.182 0 17.537C0 7.892 7.819.074 17.462.074c9.646 0 17.463 7.818 17.463 17.463'
            mask='url(#b)' />
        </g>
