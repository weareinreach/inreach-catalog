...
width={width} viewBox='0 0 36 38'>
    ...
    <g fill='none' fillRule='evenodd'>
        <g transform='translate(.26 1.052)'>
            ...
            <path fill={fillColor} d='M34.925 17.537C34.925 27.182 27.107 35 17.463 35 7.818 35 0 27.182 0 17.537 0 7.892 7.818.074 17.463.074c9.644 0 17.462 7.818 17.462 17.463'
            mask='url(#b)' />
        </g>
