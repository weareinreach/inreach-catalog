...
const SpeechBubblesIcon = ({width, fillColor, strokeColor}) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={width} viewBox="0 0 38 39">
    <g fill="none" fillRule="evenodd">
      <path
        fill={fillColor}
        d="M35.413 18.766c0 9.733-7.916 17.622-17.68 17.622C7.968 36.388.05 28.498.05 18.766c0-9.733 7.917-17.622 17.682-17.622 9.764 0 17.68 7.89 17.68 17.622"
      />
      <path
        stroke={strokeColor}
        strokeLinecap="round"
