...
const CollapseIcon = ({width, color, expanded}) => (
  ...
  {expanded ?
    <g fill='none' fillRule='evenodd'>
        ...
        <path fill={color} d='M19 19.5H5v-14h14v14zm0-16H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2v-14c0-1.1-.9-2-2-2z'
        />
...
CollapseIcon.propTypes = { width: PropTypes.string, color: PropTypes.string, expanded: PropTypes.bool }
