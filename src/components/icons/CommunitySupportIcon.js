...
const CommunitySupportIcon = ({width, fillColor}) => (
  ...
  >
    ...
    <g fill="none" fillRule="evenodd">
      ...
      <path
        d="M20.363 15.62a2.737 2.737 0 1 1-5.474 0 2.737 2.737 0 0 1 5.474 0zM25.837 18.014a1.71 1.71 0 1 1-3.42 0 1.71 1.71 0 0 1 3.42 0zM9.416 18.014a1.71 1.71 0 1 0 3.42 0 1.71 1.71 0 0 0-3.42 0zM12.152 25.198a5.474 5.474 0 0 1 10.948 0M22.135 22.099a3.484 3.484 0 0 1 5.07 3.1M8.047 25.198a3.484 3.484 0 0 1 5.07-3.1"
        stroke="#FFF"
        strokeLinecap="round"
