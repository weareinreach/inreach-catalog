...
const FavoritesList = ({ anchorEl, classes, handleClick, handleRequestClose, open }) => (
  <Grid container direction="column" alignItems="center">
    ...
    <Grid container className={classes.footer} direction="column" alignItems="center">
      <Typography className={classNames(classes.marginBottom, classes.textWhite)} type="display2">
