  ...
  render() {
    ...
    return (
      <div className="map-area">
        {infographic && <AsylumConnectInfographicButton type='button' url={infographic.url ? infographic.url : null} list={infographic.list ? infographic.list : null} text={infographic.name} />}
        <GoogleMap
